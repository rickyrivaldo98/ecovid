 ...
 */
class DataModelPuskesmas extends Model
{
    protected $table          = 'data_aktual_puskesmas';
    ...
    public function isData(int $idkabupaten, int $idpuskesmas, int $tahun, int $minggudalamtahun, int $minggudalamtahunselanjutnya)
    {
        ...
        $data = $this->db->table('data_aktual_puskesmas')->like($like)->get()->getFirstRow();
