...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'id_puskesmas'     => ['type' => 'int', 'constraint' => 10,'unsigned' => true,"null"=>true],
            'email'            => ['type' => 'varchar', 'constraint' => 255],
            'username'         => ['type' => 'varchar', 'constraint' => 30, 'null' => true],
            'nama_lengkap'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'noHP'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
        ...
        $this->forge->addForeignKey('id_puskesmas','puskesmas', 'id_puskesmas', 'CASCADE', 'CASCADE');
